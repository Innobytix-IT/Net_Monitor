# Net-Monitor v2.1 – OpenScan Projekt
...
1. [Was ist neu in v2.1?](#was-ist-neu)
...
## Was ist neu in v2.1? <a name="was-neu"></a>

Version 2.1 ist ein reines Bugfix-Release auf Basis von v2.0 und behebt folgende Probleme:
...
## Unterschiede zur alten Version (v1.0 → v2.0/2.1) <a name="unterschiede"></a>
...
- **Globale Variable `traffic_counter`** wurde ungeschützt aus mehreren Threads verändert → Race Condition. In v2.1 durch `threading.Lock()` abgesichert.
- **Kein Timeout für Report-Datei** – `report_file.close()` wurde nie erreicht (Endlosschleife ohne Break). In v2.1 korrekt mit `finally`-Block gelöst.
- **Schwellenwert-Eingabe nach der Baseline** – der Nutzer musste erst 60 Sekunden warten, bevor er den Schwellenwert eingeben konnte. In v2.1 ist alles konfigurierbar vor dem Start.
...
```
╔══════════════════════════════════════════════════════════════════════════╗
║  NET-MONITOR v2.1  │  Interface: alle  │  Filter: ip or ip6  │  Zeit   ║
╠══════════════╦═════════════════╦═══════════════════════════════════════╣
║ 📈 Verlauf   ║ pps: ▁▂▄▅▇█▇▅   ║ B/s: ▁▁▂▃▄▅▄▃                       ║
╠══════════════╬═════════════════╬═══════════════════════════════════════╣
